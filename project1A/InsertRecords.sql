INSERT INTO students (snum, ssn, name, gender, dob, c_addr, c_phone, p_addr, 
p_phone)
VALUES  
(1001, 654651234, 'Randy', 'M', '2000-12-01', '301 E Hall', '5152700988','121 
Main','7083066321'),
...
VALUES
 ...
 ( 1005, 'Applied Mathematics', 'MS'),
  (1001, 'Software Engineering', 'BS');
         INSERT INTO Courses (number, name, description, credithours, level, 
department_code)
VALUES
 (113, 'Spreadsheet', 'Microsoft Excel and Access',3,'Undergraduate',401),
 ( 311, 'Algorithm', 'Design and Analysis', 3, 'Undergraduate',401),
  (531, 'Theory of Computation', 'Theorem and Probability',3,'Undergraduate',401),
